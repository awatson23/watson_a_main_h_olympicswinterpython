...
with open("C:\\Users\\acade\\Desktop\\watson_a_main_h_olympicswinterpython\\data\\winterolympicsfrancebronze.csv") as csvfile:
...
plt.title('Percentage of bronze won by Men vs Women of France')
